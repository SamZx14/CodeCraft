...
void user(){
    ...
    ch=_getch();
        ...
        else if((ch=='x' || ch=='X' || ch == 80)&& choose<2) choose ++;
...
animation("\033[1;33mTHANK YOU FOR PLAYING CODECRAFT !",5);
printf("%s  (^-^)\n\n\n",c2(10));

animation("\033[0;34m=>> Did You Enjoy The Coding Adventure ?",8);
printf("%s  (*o*)\n\n",c2(10));
...
animation("\033[1;32m=>> WHAT'S NEXT ?",5);
printf("%s  (*-*)\n\n",c2(10));

animation("\033[1;32m# \033[0;36mChallenge Yourself Again ",8);
printf("%s---> Try %sMIX MODE %sfor the ultimate test ...!\n",c2(8),c2(6),c2(8));

animation("\033[1;32m# \033[0;36mBeat Your High Score ",8);
printf("%s---> Can you conquer %sHARD %smode ...?\n",c2(8),c2(6),c2(8));

animation("\033[1;32m# \033[0;36mShare with Friends ",8);
printf("%s---> Who's the %sBEST CODER %sin your Squad ...?\n\n",c2(8),c2(6),c2(8));

animation("\033[1;35m||> DARE IF YOU CAN DO BETTER NEXT TIME ... DARE IF YOU WANT TO PROVE YOURSELF THE BEST CODECRAFTER EVER  ...<||",8);
printf("%s  (>-*)\n\n",c2(10));

animation("\033[1;36m=>>Farewell, Future Code Master !",5);
printf("%s  (>-<)\n\n",c2(10));

animation("\033[1;37mThe best debugger is a good night's sleep ... or another round of ",8);
printf("%sCODECRAFT !\n\n",c2(13));

animation("\033[1;33m=>> Made With :\n\n",6);

animation("\033[1;31m*THE C GURU*",5);
printf("%s  (*+*)\n\n",c2(10));
...
animation("\033[1;36mGame Modes & Difficulty Levels For \033[1;34mCODECRAFTERS \033[1;36m: ",5);
printf("%s  (x.x)\n\n\n",c2(10));
